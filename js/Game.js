class Game {
  ...
  start() {
    ...
    var obstacle2Positions = [
      { x: width / 2 - 170, y: height - 1800, image: obstacle2Image },
      { x: width / 2 + 240, y: height - 2400, image: obstacle2Image },
      { x: width / 2 - 170, y: height - 4000, image: obstacle2Image },
     
      { x: width / 2 - 250, y: height - 4500, image: obstacle2Image },
